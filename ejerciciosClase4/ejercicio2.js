...
[
  ...
  const olderDevelopers=(array) =>{
    let older=array[0].age;
    for(let i=1;i<array.length;i++){
      if(array[i].age >array[i-1].age){
       older=array[i].age;
      }
    }
    let oldersDevelops=array.filter(element =>element.age==older)
    console.log(oldersDevelops);
